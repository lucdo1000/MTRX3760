...
class CWallFollower : public CRobot
{
    public:
        //---Ctor---
        // aIndex tells this robot apart from the rest of its fleet; arNoise is
        // handed on to the base class so the wheels can draw their errors.
        CWallFollower( int aIndex, const CPose& arStartPose, CNoise& arNoise );

        //---Identity---
        // The name shared by every robot of this kind.
